...
urlpatterns = [
    ...
    path('view_leave/<int:leave_id>/', employee.views.view_leave, name='view_leave'),
    ...
    path('add_performance_review/<int:employee_id>/', employee.views.add_performance_review, name='add_performance_review'),
    path('view_performance_review/<int:employee_id>/', employee.views.view_performance_review, name='view_performance_review'),
]